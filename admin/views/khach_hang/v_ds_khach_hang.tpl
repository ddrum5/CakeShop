  ...
  <tbody>
    {foreach $ds_tat_ca_khach_hang as $khach_hang}
      <tr>
        ...
        <td>
          <button type="button" class="btn btn-primary" onclick="getId({$khach_hang->ma_khach_hang})" id="update{$khach_hang->ma_khach_hang}"
            data-toggle="modal" data-target="#edit{$khach_hang->ma_khach_hang}">Sửa</button>
