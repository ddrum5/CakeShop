      ...
      <?php if ($_COOKIE['permission'] == 1) {?>
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right">
          ...
          <ul class="sidenav-second-level collapse" id="collapseMulti4">
            <li>
              <a href="khach_hang.php">Danh sách khách hàng</a>
            </li>
          </ul>
        </li>

        <li class="nav-item" data-toggle="tooltip" data-placement="right">
          <a class="nav-link nav-link-collapse collapsed" data-toggle="collapse" href="#collapseMulti5"
            data-parent="#exampleAccordion">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right">
          <a class="nav-link nav-link-collapse collapsed" data-toggle="collapse" href="#collapseMulti6"
            data-parent="#exampleAccordion">
