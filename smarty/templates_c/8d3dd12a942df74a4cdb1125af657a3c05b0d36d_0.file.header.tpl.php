<?php
/* Smarty version 3.1.30, created on 2022-05-05 10:39:02
  from "C:\xampp\htdocs\shop_hoa\smarty\templates\layouts\header.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_62738d2685e581_86682731',
...
function content_62738d2685e581_86682731 (Smarty_Internal_Template $_smarty_tpl) {
?>
<header class="row">
            ...
            <label>
                <div class="khung-tim-kiem-mobile">
                    <form class="form-inline" method="post" autocomplete="off">
                        <input name="search" id="search-mobile" class="form-control mr-sm-2" type="text" placeholder="Nhập bánh cần tìm kiếm">
                    </form>
...
">Gọi ngay: <?php echo $_smarty_tpl->tpl_vars['phone_number']->value;?>
                    ...
                    <li>
                        <div class="khung-tim-kiem-pc">
                            <form class="form-inline" method="post" autocomplete="off">
                                <input name="search" id="search" class="form-control mr-sm-2" type="text" placeholder="Nhập tên bánh cần tìm kiếm">
                            </form>
