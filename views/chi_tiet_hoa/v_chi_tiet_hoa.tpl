<div class="col-md-5 product-left-block">
    ...
    {* <div style="margin: 10px 0px 10px 0px">
        <div class="fb-shar e-button" data-href="http://{$smarty.server.HTTP_HOST}{$smarty.server.REQUEST_URI}" data-layout="button" data-size="small" data-mobile-iframe="true">
