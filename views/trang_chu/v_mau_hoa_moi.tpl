                    ...
                    <div class="category-products-grid">
                        <div class="images-container">
                            ...
                            <h2 class="product-name">
                                <a href="san-pham/{$hoa_moi->TenHoa_URL}-{$hoa_moi->MaHoa}.html"
                                    title="{$hoa_moi->TenHoa}">{$hoa_moi->TenHoa}</a>
                            </h2>
                                ...
                                <div class="actions">
                                    <div class="price-box">
                                        <a class="minimal-price-link">
                                            ...
                                            <span class="price"
                                                id="product-minimal-price-2678">{number_format({$hoa_moi->GiaKhuyenMai})}
                                                ₫</span>
                                        </a>
                                    </div>
                                </div>
